...
var tmsaXMLHttp = {
  ...
  Open : function(method, url, async, username, password) { //absinthe
    this.open(method, url, async, username, password);//absinthe
  },  //absinthe
  send : function() {
    report("[XMLHttpRequest] send HTTP request");
    this.trigger_callback();
  },
  Send : function() {//absinthe
    this.send();//absinthe
  },//absinthe
...
// GetObject = function(args){  //absinthe
//   return CC   //absinthe
// };   //absinthe

// var CC = {  //absinthe
// ExecQuery: function(){  //absinthe
//         //absinthe
//   },   //absinthe
// }   //absinthe